...
{{--                                                </div>--}}
                            ...
                            @endif
                             ...
                             @if($value == 'card_image')
                                @include('backend.pages.section_elements.card_image')
                             @endif
                            </div>
                            <?php $j++; ?>
                        @endforeach
...
@section('js')
   ...
   @include('backend.common.gallery')
   ...
   <script type="text/javascript">
       ...
       if($.inArray("card_image", section_list) !== -1) {
           ...
           $("#card-image-form").submit(function(event){
               event.preventDefault(); //prevent default action
   ...
   @include('backend.pages.partials.section_script')
